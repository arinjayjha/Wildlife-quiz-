const quizData = [
    ...
    },
    {
        ...
        "options": ["Fitness is environment-specific.", "Fitness is species-specific.",
            "Higher reproductive rate means higher fitness.", "Fitness should be measured across several generations."],
    ...
    },
    {
        "question": 'Which of these is not a characteristic of fitness?',
        "options": ["Fitness is environment-specific.", "Fitness is species-specific.",
            "Fitness works on traits such as size and speed.", "Fitness should be measured across several generations."],
...
let incorrectQuestions = []; // Store incorrect questions
...
// Load the current question and display the question count
    ...
    if (currentQuestion < quizData.length) {
        ...
        <ul class="options">
          ${questionData.options
                .map(
                    (option, index) =>
                        `<li><button onclick="checkAnswer('${option}', this)">${option}</button></li>`
                )
                .join("")}
        </ul>
      `;
    } else {
        showFinalResult(); // Show results at the end
    }
}

// Check the answer and store incorrect answers if any
function checkAnswer(selectedOption, button) {
    ...
    if (selectedOption === correctAnswer) {
        ...
        // Save incorrect question details
...
// Display final result with total marks and incorrect questions
function showFinalResult() {
    quizContainer.innerHTML = "";
    document.getElementById("question-number").textContent = ""; // Clear question number display
